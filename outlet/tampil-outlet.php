...
<html>
	...
	<body>
		 ...
		 <tr>
		 <th>Cabang</th><th>Alamat</th><th>Nomor Telepon</th>
		 </tr>
		...
		<td>
            <a href="hapus_outlet.php?cabang=<?=$outlet['Cabang']?>"
		    onclick="return confirm('Apakah anda yakin menghapus data outlet ini?')" class="btn btn-danger">Hapus</a></td>
		</tr>
